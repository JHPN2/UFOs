...
// Note: The code we helped create will add every object in ou data.js file to the table. Bundled into 
// one tidy package, every sighting will be available to view.

// D3 functions and If statements
